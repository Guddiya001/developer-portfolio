...
import reacttestinglibrary from '../app/assets/svg/skills/react-testing-library.svg'
import reduxtoolkit from '../app/assets/svg/skills/redux-toolkit.svg'


// Add more skills here as per the available skills above
// Make sure to import the svg file and give a proper name  to it
// and then add the case in the switch statement below      
